...
tags:
  ...
  - Web
---
The jQuery Mobile framework has a [list view widget](https://jquerymobile.com/demos/1.0/docs/lists/docs-lists.html){:target="_blank"} that displays unordered lists in several different ways. In the process of converting the [Microsoft Global MVP Summit mobile](https://mvpsummitevents.info/m/){:target="_blank"} site to use jQuery Mobile, I wanted to change the way I displayed the events. The idea was to have a header for each date that there was an event along with some of the details of the event. Clicking on the event would take you the to event details page. To accomplish this I used the [count bubble](https://jquerymobile.com/demos/1.0/docs/lists/lists-count.html){:target="_blank"}, [list dividers](https://jquerymobile.com/demos/1.0/docs/lists/lists-divider.html){:target="_blank"}, [content formatting](https://jquerymobile.com/demos/1.0/docs/lists/lists-formatting.html){:target="_blank"} and the [search filter bar](https://jquerymobile.com/demos/1.0/docs/lists/lists-search.html){:target="_blank"} features of jQuery Mobile. First let's look at the HTML, for the sake of brevity I removed the ID fields from the HTML.
