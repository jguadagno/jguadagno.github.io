...
Next up, add the Azure Active Directory Settings to your `appsettings.Development.json` file.  **Note**, you should not store client secrets or PII in your version repository, Git, SVN, TFS, etc. you should use the '[user secrets](https://docs.microsoft.com/en-us/aspnet/core/security/app-secrets?view=aspnetcore-3.1&tabs=windows&?wt.mc_id=DT-MVP-4024623){:target="_blank"}' functionality, [Azure App Configuration](https://azure.microsoft.com/en-us/services/app-configuration/?wt.mc_id=DT-MVP-4024623){:target="_blank"} service, or [Azure Key Vault](https://azure.microsoft.com/en-us/services/key-vault/?wt.mc_id=DT-MVP-4024623){:target="_blank"} service.  For now, I will show it the `appsettings.development.json`.
